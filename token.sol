...
contract DiamondhandsToken is ERC20, Ownable {
    /*
    ...
    */
    ...
    uint128 public minTokensBeforeSwap = 1 * 10**6 * 10**18; // 100 million mininum
    ...
    uint32 public _autoBurn = 10;
    uint32 public _devFee = 200;
    uint32 public _manualBurn = 100;
    ...
    constructor(
    ...
    ) public ERC20("DiamondhandsToken", "DHT") {
        // mint tokens which will initially belong to deployer
        // deployer should go seed the pair with some initial liquidity
        _mint(msg.sender, 1000000 * 10**8 * 10**18);
        
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);  // kovan uni
        ...
        _devWallet = 0x4Ba09bFE1ff1AACeAE099E7b8302B5c035F8381F;
        _manualBurnWallet = 0x0014D8a0c42E5eC5D69B2B9190186C494E2a6905;
    ...
    */
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_feesDisabled) {
